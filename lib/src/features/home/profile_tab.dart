...
class _ProfileTabState extends State<ProfileTab> {
  ...
  Future<void> _uploadPhoto() async {
    ...
    try {
      ...
      final imagePath = '/$userId/profile.$imageExtension'; // Ruta: /id_usuario/profile.jpg
      ...
      await supabase.storage.from('avatars').uploadBinary(
        imagePath,
        imageBytes,
        fileOptions: const FileOptions(upsert: true), // Sobreescribir si existe
      );
      ...
      final urlWithTimestamp = '$imageUrl?v=${DateTime.now().millisecondsSinceEpoch}';
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Error al subir foto'), backgroundColor: Colors.red));
      }
    } finally {
              ...
              _isUploading 
                ...
                : CircleAvatar(
                    ...
                    child: avatarUrl == null 
                        ? Text(name.isNotEmpty ? name[0].toUpperCase() : 'U', style: const TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Colors.orange))
                        : null,
                  ),
              Positioned(
                bottom: 0,
                ...
                child: GestureDetector(
                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            onTap: () async {
                              ...
                              final result = await Navigator.push(context, MaterialPageRoute(builder: (context) => EditProfilePage(currentName: name, currentPhone: phone, currentEmail: email,)));
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(color: Color(0xFF0A7AFF), shape: BoxShape.circle),
