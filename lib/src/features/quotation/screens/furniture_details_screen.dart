...
class _FurnitureDetailsScreenState extends State<FurnitureDetailsScreen> {
  ...
  final Map<String, double> _basePrices = {
    ...
    'Sofá 3 plazas': 850.0,
    'Sofá en L': 1200.0,
    'Sillón Individual': 350.0,
    'Alfombra de Área': 400.0,
    'Tapete Chico': 200.0,
    'Alfombra Fija (m2)': 80.0,
    'Colchón Individual': 400.0,
    'Colchón Matrimonial': 600.0,
    'Colchón King Size': 900.0,
  };
  ...
  final List<String> _stainOptions = [
    'Comida',
    'Bebida',
    'Mascota',
    'Grasa',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          value:
                              _currentType, // Corregido: value en vez de initialValue para actualizarse dinámicamente
                          isExpanded: true,
                          decoration: _inputDecoration(),
                          items: _currentFurnitureTypes
                              .map(
                                (t) => DropdownMenuItem(
                                  value: t,
                                  child: Text(
                              ...
                              .map(
                                (s) => FilterChip(
                                  ...
                                  onSelected: (sel) => setState(() {
                                    sel
                                        ? _currentStains.add(s)
                                        : _currentStains.remove(s);
                                  }),
                                  selectedColor: const Color(0xFFE0F2FF),
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  IconButton(
                                    icon: const Icon(Icons.add, color: mubBlue),
                                    onPressed: () =>
                                        setState(() => _quantity++),
                                  ),
                                ],
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => PhotoUploadScreen(
                              ...
                              itemsTotal:
                                  _totalCartPrice, // Se pasa el total interno, pero no se muestra
                            ),
                          ),
                        );
                      },
